...
RESULTS_PATH = os.path.join(script_dir_file, f"eval_student_bench_results_{RUN_ID}.pt")
...
def main():
    ...
    metrics_path = os.path.join(script_dir_file, f"eval_student_bench_metrics_{RUN_ID}.json")

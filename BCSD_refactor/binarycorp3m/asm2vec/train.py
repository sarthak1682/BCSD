...
# Setup path to the asm2vec-pytorch submodule relative to this script
...
def main():
    ...
    # Path to train dataset (located in repository root or hardcoded on the cluster)
    repo_root = os.path.abspath(os.path.join(script_dir, "../../../"))
    jsonl_path = "/home/ra72yeq/projects/NovaXLLM2Vec/binarycorp_train.jsonl"
    if not os.path.exists(jsonl_path):
        jsonl_path = os.path.join(repo_root, "binarycorp_train.jsonl")
        
    temp_dir = os.path.join(script_dir, "asm2vec_train_temp")
    ...
    save_dir = os.path.join(script_dir, "asm2vec_weights")

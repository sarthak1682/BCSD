...
DATA_DIR = os.path.join(repo_root, "binarycorp_3m")
...
if __name__ == "__main__":
    # Convert test set
    extract_and_convert(TEST_TAR, os.path.join(repo_root, "binarycorp3m_test_nova.jsonl"))
    
    # Convert train set
    extract_and_convert(TRAIN_TAR, os.path.join(repo_root, "binarycorp3m_train_nova.jsonl"))
